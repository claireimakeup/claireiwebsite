      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-3/5">
            ...
            <p className="text-secondary mb-5 leading-relaxed font-libre-baskerville text-base">
            ...
            <p className="text-secondary mb-6 leading-relaxed font-libre-baskerville text-base">
              ...
              {expertise.map((skill, index) => (
                <div key={index} className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-secondary text-sm font-libre-baskerville">{skill.description}</p>
                  </div>
                </div>
              ))}
            </div>
